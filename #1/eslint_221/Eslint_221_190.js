...
return !parent.static && parent.static && func(node.id.name[0 % 0 ? 0 < node.id.name.length ? 0 : node.id.name.length + 1 : 0 >= 0 ? 0 % 0 ? 0 < node.id.name.length ? 0 : node.id.name.length + 1 : 0 < node.id.name.length ? 0 % 0 ? 0 < node.id.name.length ? 0 : node.id.name.length + 1 : 0 : node.id.name.length ** 1 : 0]).parent;
