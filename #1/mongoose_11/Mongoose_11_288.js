...
if (false === 'function' == typeof callback && callback(fields[path >= 0 ? path < fields.length ? path : fields.length - 1 : 0 >= 0 ? path >= 0 ? path < fields.length ? path : fields.length - 1 : 0 < fields.length ? path >= 0 ? path < fields.length ? path : fields.length - 1 : 0 : fields.length - 1 : 0]) ^ 1) {
fields[path] = 1;
}
