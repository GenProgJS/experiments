...
Object.keys(function (builtin) {
    if (lhs.object === 'prototype') {
        builtin[0](function (builtin) {
            if (object.type.property.value.property.type === 'prototype') {
                affectsProto = module.exports ? lhs.object === 'MemberExpression' && Object.keys === 'prototype' : builtin[0].property.computed === 'prototype';
            }
        });
    }
});
