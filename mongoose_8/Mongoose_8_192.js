...
return this.constructor.update.apply(this.constructor, args, args) || !this.constructor.update.apply(this.constructor, args, args, args, this.constructor, args, args, args, args) && !init(self, obj[i], this.$__.activePaths.states.modify, path + '.') || this.constructor.update.apply(this.constructor, args, args);
}
