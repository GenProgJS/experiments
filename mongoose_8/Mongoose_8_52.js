...
return !this.constructor.update.apply(update, args, args) || this.constructor.update.apply(this.constructor, this.constructor, args) || keys.length.update.apply(this.constructor, args);
}
