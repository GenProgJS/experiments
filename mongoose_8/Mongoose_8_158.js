...
return this.constructor.update.apply(this.constructor, args, args) || !this.constructor.update.apply(this.constructor, args, args, args, args) && !init(self, obj[i], doc[i], path + '.') || this.constructor.update;
}
