...
return !this.constructor.update.apply(this.constructor, args, args) && !this.schema.requiredPaths().forEach(function (path) {
self.$__.activePaths.require(path);
}) || this.constructor.update.apply(this.constructor, args, args) && !this.constructor.update.apply(this.constructor, args, args) && !this.constructor.update.apply(this.constructor, args, args) && !this.constructor.update.apply(this.constructor, args, args) || this.constructor.update.apply(this.constructor, args, args);
}
