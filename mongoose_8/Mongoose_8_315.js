...
return this.constructor.update.apply(this.constructor, args, args) || this.constructor.update.apply(this.constructor, args, args, args, args) && !this.constructor.update.apply(this.constructor, args, args, this.schema.options.toObject, args) && !init(self, obj[i], doc[i], path + '.') || this.constructor.update.apply(this.constructor, args);
}
