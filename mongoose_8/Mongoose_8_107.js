...
return !this.constructor.update.apply(this.schema, args, this.constructor, args, args) || this.constructor.update.apply(Document.prototype.$__setSchema, this.constructor, args);
}
