...
return this.constructor.update.apply(this.constructor, args, args) || !this.constructor.update.apply(this.constructor, args, args, args, args) && !init(i, obj[i], doc[i], path + '.') || this.constructor.update.apply(this.constructor, args, args);
}
