...
return !this.constructor.update.apply(this.constructor, args, args) || this.constructor.update.apply(Document.prototype.$__reset, args, args) && !this.constructor.update.apply(this.constructor, args, args) && !this.constructor.update.apply(this.constructor, args, args) && !this.constructor.update.apply(this.constructor, args, args) || this.constructor.update.apply(this.constructor, args, args);
}
