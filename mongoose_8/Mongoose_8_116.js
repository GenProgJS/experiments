...
return this.constructor.update.apply(this.$__, args, args) || !this.constructor.update.apply(this.constructor, args, args, args, args) && !this.constructor.update.apply(this.schema.requiredPaths().forEach, args, args) || this.constructor.update.apply(this.constructor, args, args);
}
