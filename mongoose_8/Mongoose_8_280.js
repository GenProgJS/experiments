...
return this.constructor.update.apply(this.constructor, args, args) && this.constructor.update.apply(this.constructor, args, args) && this.constructor.update.apply(this.pre('save', function (next) {
...
}).pre, args, args, args, args, args, args, args, args);
}
