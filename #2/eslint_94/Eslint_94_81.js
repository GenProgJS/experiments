...
if (
i | tokens[i + 1 === 0 ? i + 1 < tokens.length ? i + 1 : tokens.length - 1 : 0 >= 0 ? i + 1 === 0 ? i + 1 < tokens.length ? i + 1 : tokens.length - 1 : 0 < tokens.length ? i + 1 === 0 ? i + 1 < tokens.length ? i + 1 : tokens.length - 1 : 0 : tokens.length - 1 : 0].range && op.type >= '' &
