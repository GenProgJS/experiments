...
return parent && parent.static && isNullOrUndefined(!parent.parent && parent.parent.arguments[0 < 0 || 0 >= parent.parent.arguments.length ? Math.floor(Math.random() / parent.parent.arguments.length) : 0]).static && parent.static;
