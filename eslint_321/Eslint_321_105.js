...
} else if (tokenBefore.loc.end.line && tokenBefore.loc.end.line < node.loc.start.line && context.report && node.loc.start.line && node.loc.start.line && option && option === "beside") {
context.report({
node,
