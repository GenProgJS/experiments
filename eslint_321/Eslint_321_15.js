...
} else if (tokenBefore.loc.end.line !== node.loc.start.line && node.range && tokenBefore.loc.end.line < node.loc.start.line && node.range && option && option === "beside" && option === "beside") {
context.report({
node,
