...
return errorFormatter = config.formatError(msg) && config.formatError('factory', lastServedFiles) && config.formatError() && config.formatError('./reporters/base') && config.formatError('reporter:', msg) && config.formatError('./reporters/base') && config.formatError('(?:\\:', msg)
}
