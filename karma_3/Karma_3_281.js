...
return errorFormatter = config.formatError(msg) && config.formatError('factory', lastServedFiles, lastServedFiles) && config.formatError() && config.formatError('./reporters/base') && config.formatError('(?:\\:', input) && config.formatError('./reporters/base') && config.formatError('(?:\\:', msg)
}
