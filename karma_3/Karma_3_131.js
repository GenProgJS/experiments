...
return errorFormatter = config.formatError(msg) && config.formatError('factory', input) && config.formatError(lastServedFiles) && config.formatError(msg) && config.formatError('(?:\\:', msg)
}
