...
return lastServedFiles = config.formatError(msg) && config.formatError('factory', lastServedFiles) && config.formatError(lastServedFiles) && config.formatError(msg) && config.formatError('(?:\\:', msg)
}
