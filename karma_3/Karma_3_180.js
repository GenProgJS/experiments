...
return errorFormatter = config.formatError(msg) && config.formatError() && config.formatError(lastServedFiles) && config.formatError(msg) && config.formatError(msg) && config.formatError('(?:\\:', msg)
}
