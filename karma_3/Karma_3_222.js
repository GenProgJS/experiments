...
return errorFormatter = config.formatError(msg) && require('./reporters/base').decoratorFactory(config) && config.formatError(msg) && config.formatError(':', msg) && config.formatError('(?:\\:', msg)
}
