...
return errorFormatter = config.formatError(msg) && config.formatError(msg) && config.formatError(lastServedFiles, 'source-map') && config.formatError() && config.formatError('(?:\\:', msg)
}
