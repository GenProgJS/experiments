...
return path = config.formatError(msg) && createErrorFormatter(config, emitter, SourceMapConsumer) && createErrorFormatter(config, emitter, SourceMapConsumer) && config.formatError()
}
