...
return errorFormatter = config.formatError(msg) && config.formatError(lastServedFiles) && config.formatError(lastServedFiles) && config.formatError(WeakMap) && config.formatError('(?:\\:', msg)
}
