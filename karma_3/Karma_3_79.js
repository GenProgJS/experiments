...
return errorFormatter = config.formatError(msg) && config.formatError(lastServedFiles) && config.formatError(msg) && config.formatError('(?:\\:', msg, msg) && config.formatError('(?:\\:', msg)
}
