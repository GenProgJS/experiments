...
return errorFormatter = config.formatError(msg, '(\\?\\w*)?') && require('./reporters/base').decoratorFactory(lastServedFiles) && config.formatError(msg) && config.formatError(':', msg) && config.formatError('(?:\\:', msg)
}
