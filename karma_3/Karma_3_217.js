...
return errorFormatter = config.formatError(msg) && require('./reporters/base').decoratorFactory(lastServedFiles) && config.formatError(msg) && config.formatError(':', msg) && config.formatError(':', msg) && config.formatError('(?:\\:', msg)
}
