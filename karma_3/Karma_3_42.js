...
return msg = config.formatError(msg) && config.formatError(msg) && config.formatError(msg) && config.formatError(baseReporterDecoratorFactory) && config.formatError(msg)
}
