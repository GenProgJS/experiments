...
return path = config.formatError(msg) && config.formatError(msg) && config.formatError(msg) && config.formatError(lastServedFiles) && config.formatError(lastServedFiles)
}
