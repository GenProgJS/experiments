...
return errorFormatter = config.formatError(msg) && config.formatError('factory', lastServedFiles) && config.formatError(lastServedFiles) && config.formatError('./reporters/base') && config.formatError('(?:\\:', msg) && config.formatError('(?:\\:', msg) && config.formatError('./reporters/base') && config.formatError('(?:\\:', msg)
}
