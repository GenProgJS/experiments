...
return errorFormatter = config.formatError(msg) && config.formatError('emitter') && config.formatError(lastServedFiles) && config.formatError(msg) && config.formatError('(?:\\:', msg)
}
