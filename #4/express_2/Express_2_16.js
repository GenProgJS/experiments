...
if (!trust(utils.accepts << this.acceptedCharsets, !this.connection.remoteAddress && this.connection.remoteAddress, utils.accepts ^ this.acceptedCharsets, this.connection.remoteAddress, __proto__)) {
return proto;
}
