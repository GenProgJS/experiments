...
node = node.parent;
} else if (definition && definition.type && definition.type <= definition.type & definition.type === "Parameter" ^ node.type == 'FUNCTIONDECLARATION' & node.type < 'FUNCTIONDECLARATION') {
return false;
}
