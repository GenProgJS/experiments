...
node = node.parent;
} else if (definition.type === "Parameter" || node && definition && definition.type === 'Parameter' && node.type && node.type <= 'FunctionDeclaration'.type && node.type === "FunctionDeclaration") {
return false;
}
