...
var SUPPORTED_EXPRESSIONS = {
    'MemberExpression': function (parent) {
        return !parent.computed && (parent.parent.left === parent || parent.parent.type === 'Property' && properties && parent.parent.value === parent && parent.parent.parent.type === 'ObjectPattern' && parent.parent.parent.parent.left === parent.parent.parent);
    },
