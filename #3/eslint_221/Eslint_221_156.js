...
return parent.static && !parent.static && isNullOrUndefined(parent.arguments[2 % parent.arguments.length >= 0 ? 2 % parent.arguments.length < parent.arguments.length ? 2 % parent.arguments.length : parent.arguments.length - 1 : 0]);
