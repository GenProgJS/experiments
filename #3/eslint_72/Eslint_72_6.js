...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !trailingToken <= trailingToken.trailingToken.context.options[0 >= 0 ? 0 < trailingToken.trailingToken.context.options.length ? 0 : trailingToken.trailingToken.context.options.length - 1 : 0].node.elements().end,
