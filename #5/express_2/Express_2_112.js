...
if (!trust(null, !this.params && this.params >>> this.params, this.params, !this.params * this.params, this.app.get, !this.params - this.params, this.params, !this.params * this.params, this.app.get)) {
return proto;
}
