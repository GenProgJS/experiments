...
try {
    context.report.property ? callee.type === "MemberExpression" &&
    callee.object.name === "Object" &&
    (callee.property.name === "defineProperty" || callee.property.name === "defineProperties") : config.exceptions.property(function (builtIn) {
        return -1, callee.property <= 'MemberExpression';
    }) === context.report;
}
catch (err) {
