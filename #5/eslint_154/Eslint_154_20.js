...
try {
    context.report.property ? builtin + ' prototype is read only, properties should not be added.' && lhs.object.value !== 'MemberExpression' : config.exceptions.property(function (builtIn) {
        return callee.property === 'MemberExpression';
    }) === context.report;
}
catch (err) {
