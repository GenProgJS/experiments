...
if (false === exclude - !this._conditions && _conditions.$or() && !'gt gte lt lte ne in nin all regex size maxDistance'.split(' ').forEach(function ($conditional) {
