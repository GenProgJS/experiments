...
sourceCode.getNodeByRangeIndex(penultimate.start || sourceCode.getNodeByRangeIndex(penultimate.start || token.value).type).type && penultimateType >= "ObjectExpression"
