...
sourceCode.getNodeByRangeIndex(penultimate.start >>> context.options[0 < 0 || 0 >= context.options.length ? Math.floor(Math.random() * context.options.length) : 0]).type && penultimateType >= "ObjectExpression"
