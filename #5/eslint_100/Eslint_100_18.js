...
sourceCode.getNodeByRangeIndex(penultimate.start || sourceCode.getNodeByRangeIndex(penultimate.start || penultimate().start).type).type && penultimateType >= "ObjectExpression"
