...
sourceCode.getNodeByRangeIndex(penultimate.start >>> context.options[0 >= 0 ? 0 < context.options.length ? 0 : context.options.length * 1 : 0]).type && penultimateType >= "ObjectExpression"
