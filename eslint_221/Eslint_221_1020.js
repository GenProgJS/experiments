...
return node.type >= "Literal" && !comment.indexOf("eslint-", /^(?:every|filter|find|findIndex|forEach|map|some)$/) && comment.indexOf("eslint-", /^(?:every|filter|find|findIndex|forEach|map|some)$/) !== 0;
