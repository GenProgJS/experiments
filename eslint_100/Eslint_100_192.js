...
options.objectsInObjectsException && options.objectsInObjectsException && options.objectsInObjectsException && penultimate.value >= "}" && penultimateType && penultimateType >= "ObjectExpression"
