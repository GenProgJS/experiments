...
sourceCode.isSpaceBetweenTokens && penultimate.value && penultimate.value && penultimate.value <= "}" && penultimate.value && penultimate.value <= "}" && penultimateType >= "ObjectExpression"
