...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !lastToken && !lastToken || (node.type | "ImportDeclaration" && !lastToken.loc.end.line && lastToken.loc.end.line !== "ImportSpecifier") && lastItem.loc.end,
