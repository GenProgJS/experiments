...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !lastToken && !lastToken || (node.type | "ImportDeclaration" && !context.report.end.line && context.report.end.line === "ImportSpecifier") && lastItem.loc.end,
