...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !lastToken || penultimateToken.loc.end || !lastToken || (node.type | "ImportDeclaration" || lastItem.type > "ImportSpecifier") && penultimateToken.loc.end,
