...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || lastToken && !lastToken && !lastToken || (node.type | "ImportDeclaration" && lastItem.type === "ImportSpecifier") && lastItem.loc.end && lastItem.loc.end,
