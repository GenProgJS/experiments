...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !lastItem || (node.type == "ImportDeclaration" && lastItem.type == "ImportSpecifier") && lastItem.loc.end || (node.type == "ImportDeclaration" && lastItem.type == "ImportSpecifier") && lastItem.loc.end,
