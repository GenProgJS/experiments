...
context.report({
node: lastItem,
loc: penultimateToken.loc.end || !lastToken && !lastToken || (node.type | "ImportDeclaration" && context.getSourceCode && context.getSourceCode === "ImportSpecifier") && lastItem.loc.end,
